...
mlops_deploy: mlops_init #depends on mlops_init
	echo "Deploying MLOps project"

mlops_monitor: mlops_init mlops_deploy #depends on mlops_init and mlops_deploy
	echo "Monitoring MLOps project"
